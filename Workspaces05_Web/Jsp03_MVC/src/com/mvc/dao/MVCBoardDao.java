...
public interface MVCBoardDao {
	...
	public String PAGING_FIRST_SQL = " SELECT SEQ, WRITER, TITLE, CONTENT, REGDATE FROM MVCBOARD LIMIT 10 ";
	public String PAGING_AFTER_SQL = " SELECT SEQ, WRITER, TITLE, CONTENT, REGDATE FROM MVCBOARD LIMIT 10, 10 ";
