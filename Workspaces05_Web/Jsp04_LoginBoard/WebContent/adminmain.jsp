...
/*
	...
	response.setHeader("Exprise", "0");						// proxy server
	
	우리는 : http 1.1 (Connector port="8787" protocol="HTTP/1.1")
*/
%>
...
<body>
	...
	<div>
		...
		<div>
			<a href="logincontroller.jsp?command=listen">회원 전체 조회(MTMENABLED=Y)</a>
		</div>
	</div>
