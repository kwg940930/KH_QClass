...
.full1 {height: 100vh; background-color: #4481eb;}
.full2 {height: 100vh; background-color: #04befe;}
.full3 {height: 100vh; background-color: #4481eb;}
.full4 {height: 100vh; background-color: #04befe;}
.full5 {height: 100vh; background-color: #4481eb;}
	...
	function fullset() {
		...
		$(window).bind("mousewheel",
				function(event) {
					...
					if (event.originalEvent.wheelDelta >= 0) { //마우스 휠을 위로 올릴때
						...
						var nextPage = parseInt(page.index() + 1); //다음 페이지번호 
