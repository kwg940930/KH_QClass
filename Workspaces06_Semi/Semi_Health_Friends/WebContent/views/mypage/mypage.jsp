...
.countBackground:hover {color:hotpink;}
.countview:hover{color:hotpink; }
				...
				<table class="profile-border">
					...
					<tr	>
						<td colspan="2" >
							...
							<br>
								<input type="file" name="filename" size='20'> <input name="profilename" type="submit" value="프로필 사진 변경 하기">
							</form>
						</td>
					</tr>
					<tr>
					...
					<br>
					<tr>
						<td colspan="2" class="profile-border" >이메일 : <%=Ldto.getMember_email()%><br>
							<span style="font-weight: bold; color: darkblue">아이디 : <%=Ldto.getMember_id()%></span>
						</td>
					</tr>
					<tr >
			...
			<div class="mypage-list-div">
				<table class="list-border"><br>
					...
					<tr>
						<td>
							<ul class="list-ul">
								<li><a href="mypage.do?command=registUpdate" class="mypage-list-li">회원정보 수정</a></li>
								<li><a href="scrap.do?command=scrapList" class="mypage-list-li">찜한게시물</a></li>
								<li><div class="mypage-follw-div mypage-list-li" onclick="follow();" id="follow">팔로우</div></li>
								<li><a href="payment.do?command=paymentRoleUp&member_role=<%=Ldto.getMember_role()%>" class="mypage-list-li">프리미엄 등록</a></li>
								<li><a href="payment.do?command=paymentRoleDown&member_role=<%=Ldto.getMember_role()%>" class="mypage-list-li">프리미엄 탈퇴</a></li>
								<li><a href="payment.do?command=paymentListMyPaging&member_email=<%=Ldto.getMember_email()%>" class="mypage-list-li">나의 결제내역</a></li>
							</ul>
						</td>
					</tr>
				</table>
