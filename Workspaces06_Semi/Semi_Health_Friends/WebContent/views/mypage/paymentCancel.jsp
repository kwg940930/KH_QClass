...
<form action="" id="join">
	<h2 style="color:gray; text-align: center;">탈퇴를 위한 안내입니다.</h2>
	<br>
        <ul class="box">
            ...
            <li class="checkBox check02">
                ...
                <textarea name="" id="">
                	여러분을 환영합니다.
					우리동네 운동메이트(이하 ‘서비스’)를 이용해 주셔서 감사합니다. 
					본 약관은 다양한  서비스의 이용과 관련하여 우리 동네 운동 메이트 서비스를 
					제공하는 우리 동네 운동 메이트 주식회사(이하 ‘우리 동네 운동 메이트’)와 
					이를 이용하는 우리 동네 운동 메이트 서비스 회원(이하 ‘회원’) 또는 비회원과의 관계를 설명하며, 아울러 
					여러분의 우리 동네 운동 메이트 서비스 이용에 도움이 될 수 있는 유익한 정보를 포함하고 있습니다.
       			</textarea>
            </li>
            ...
            <input type="button" id="mpage01" onclick="location.href='payment.do?command=paymentDowndate&member_email=<%=Ldto.getMember_email()%>'" value="탈퇴하기">
			<input type="button" id="mpage02" onclick="location.href='./mypage.do?command=mypage'" value="돌아가기">
		</div>
    </form>
